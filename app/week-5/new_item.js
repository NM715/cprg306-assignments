...
export default function NewItem() {
  ...
  return (
    <div className="flex items-center justify-center w-auto mt-0">
      <div className="mt-3 bg-blue-950 p-3 rounded-lg shadow-md">
        <form onSubmit={handleSubmit} className="space-y-2">
          ...
          <div className="flex items-start">
            <div className="w-44 h-12 mx-auto mt-2 ml-2 rounded-lg bg-white p-2">
